...
function GradientBackgroundMixin:SetGradientBackground(leftWidth, rightWidth, color, opacity)
  ...
  self.leftBg:SetGradient("HORIZONTAL", CreateColor(color.r, color.g, color.b, 0), CreateColor(color.r, color.g, color.b, opacity)
  )
  ...
  self.rightBg:SetGradient("HORIZONTAL", CreateColor(color.r, color.g, color.b, opacity), CreateColor(color.r, color.g, color.b, 0)
  )
